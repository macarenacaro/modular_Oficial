...
namespace modulAR_M.Caro.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public CategoriasController(MvcModularContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categorias != null ? 
                          ...
                          Problem("Entity set 'MvcModularContexto.Categorias'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcModularContexto.Categorias'  is null.");
            }
            var categoria = await _context.Categorias.FindAsync(id);
            if (categoria != null)
            {
