...
namespace modulAR_M.Caro.Controllers
{
    public class PedidosController : Controller
    {
        ...
        public PedidosController(MvcModularContexto context)
        {
            _context = context;
        }
        ...
        {
            var mvcModularContexto = _context.Pedidos.Include(p => p.Cliente).Include(p => p.Estado);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcModularContexto.Pedidos'  is null.");
            }
            var pedido = await _context.Pedidos.FindAsync(id);
            if (pedido != null)
            {
